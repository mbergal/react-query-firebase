...
import { useQuery, hashQueryKey, useQueryClient, useMutation } from 'react-query';
import { setWithPriority, set, update, remove, runTransaction } from '@firebase/database';
...
function useDatabaseSnapshot(queryKey, ref, options, useQueryOptions) {
    ...
    var subscribeFn = useCallback(function (callback) {
        return onValue(ref, function (snapshot) {
...
function useDatabaseSetMutation(ref, options, useMutationOptions) {
    return useMutation(function (value) {
...
export { useDatabaseRemoveMutation, useDatabaseSetMutation, useDatabaseSnapshot, useDatabaseTransaction, useDatabaseUpdateMutation, useDatabaseValue };
